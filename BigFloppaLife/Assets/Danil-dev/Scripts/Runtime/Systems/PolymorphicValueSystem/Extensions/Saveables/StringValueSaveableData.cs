...
{
    [System.Serializable]
    public class StringValueSaveableData : BaseSaveableData<string>
    {
        #region Fields

        [SerializeReference] private PolymorphicValue<string> _value = new StringConstantValue();
        [SerializeReference] private PolymorphicValue<string> _defaultValue = new StringConstantValue();
