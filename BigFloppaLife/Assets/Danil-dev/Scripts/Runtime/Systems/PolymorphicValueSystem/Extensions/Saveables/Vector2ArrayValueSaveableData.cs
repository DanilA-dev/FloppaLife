...
{
    [System.Serializable]
    public class Vector2ArrayValueSaveableData : BaseSaveableData<Vector2[]>
    {
        #region Fields

        [SerializeReference] private PolymorphicValue<Vector2[]> _value = new Vector2ArrayConstantValue();
        [SerializeReference] private PolymorphicValue<Vector2[]> _defaultValue = new Vector2ArrayConstantValue();
