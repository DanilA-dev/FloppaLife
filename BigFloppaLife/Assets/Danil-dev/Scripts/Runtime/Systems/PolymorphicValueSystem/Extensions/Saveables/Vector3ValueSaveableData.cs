...
{
    [System.Serializable]
    public class Vector3ValueSaveableData : BaseSaveableData<Vector3>
    {
        #region Fields

        [SerializeReference] private PolymorphicValue<Vector3> _value = new Vector3ConstantValue();
        [SerializeReference] private PolymorphicValue<Vector3> _defaultValue = new Vector3ConstantValue();
