...
{
    [System.Serializable]
    public class DoubleArrayValueSaveableData : BaseSaveableData<double[]>
    {
        #region Fields

        [SerializeReference] private PolymorphicValue<double[]> _value = new DoubleArrayConstantValue();
        [SerializeReference] private PolymorphicValue<double[]> _defaultValue = new DoubleArrayConstantValue();
